...
const Sidebar = () => {
    const styles = {
        ...
        profile: ` w-full py-10 flex flex-col justify-center items-center rounded-r-3xl bg-gradient-to-t from-[#0d141c] to-[#42667e] mt-[10px] mb-[30px] border-2 border-[#fb9701]`,
